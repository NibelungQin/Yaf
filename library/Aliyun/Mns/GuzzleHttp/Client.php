...
use Aliyun\Mns\GuzzleHttp\Cookie\CookieJar;
use Aliyun\Mns\GuzzleHttp\Promise;
use Aliyun\Mns\GuzzleHttp\Psr7;
use Aliyun\Mns\Psr\Http\Message\UriInterface;
use Aliyun\Mns\Psr\Http\Message\RequestInterface;
use Aliyun\Mns\Psr\Http\Message\ResponseInterface;
require 'functions.php';
require 'Psr7/functions.php';
require 'Promise/functions.php';
/**
...
class Client implements ClientInterface
{
     ...
     *   Aliyun\Mns\GuzzleHttp\Promise\PromiseInterface that is fulfilled with a
     ...
     *
     * @see \Aliyun\Mns\GuzzleHttp\RequestOptions for a list of available request options.
     */
