...
class Qrcode {
	 ...
	 */
	 protected function encodeModeAn($inputitem, $version) {
		...
		$inputitem['bstream'] = $this->appendNum($inputitem['bstream'], $this->lengthIndicator($this->QR_MODE_AN, $version), $inputitem['size']);
		for ($i=0; $i < $words; ++$i) {
	...
	* Return block number 1
	 ...
	 * 
	 */
	public function png($str = '', $filename = false, $eclevel = "H", $pixelPerPoint = 8, $outerFrame = 2, $saveandprint = 85)
	{
